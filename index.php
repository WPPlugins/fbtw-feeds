...
function sdfbtw_frontend_scripts() {
    ...
    global $wpdb, $app_id, $select_lang, $fb_tw_options, $fbtw_timeline_width, $fbtw_timeline_height;
    ...
    if (!is_admin()) {
        ...
        $select_lang = $fb_tw_options['section_facebook_language'];
        ...
        $local_vars = array('app_id' => $app_id, 'select_lang' => $select_lang, 'btn_position' => $btns_position, 'visible_on_device' => $visible_on_device, 'fbtw_wrapper_width' => $fbtw_wrapper_width, 'fbtw_wrapper_height' => $fbtw_wrapper_height);
